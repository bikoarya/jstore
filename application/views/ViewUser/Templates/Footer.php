			...
			<div class="row">
				<div class="col-sm-7">
					<div class="companyinfo">
						<h2><span>J</span>-Store</h2>
						<p>Temukan perawatan yang tepat untuk tubuh anda</p>
					</div>
				</div>
				<!-- <div class="col-sm-7">
						<div class="col-sm-3">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<div class="single-widget">
						...
						<ul class="nav nav-pills nav-stacked">
							<li>Email</li>
							<li><a href="">jstore@gmail.com</a></li>

							<li>Lokasi Kami</li>
							<li><a href="">Jl. Baliwinata Blok 17C/12</a></li>
						</ul>
					</div>
				</div>
				<div class="col-sm-2">
					<div class="single-widget">
						...
						<ul class="nav nav-pills nav-stacked">
							...
							<li><a href="">Kebijakan JStore</a></li>
