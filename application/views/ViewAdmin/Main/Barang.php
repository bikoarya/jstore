...
<!-- Modal -->
<div class="modal fade" id="editBarang" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document" style="border: none;">
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: 0 none;">
                <h5 class="modal-title mt-3" id="exampleModalLabel">Tambah Barang</h5>
            ...
            <div class="modal-body">
                <form id="formEditBarang" action="<?= site_url('Master/Barang/insert'); ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="txtNamaBarang">Nama Barang</label>
                        <input type="text" class="form-control" name="txtEditBarang" id="txtEditBarang" placeholder="Nama Barang" autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="txtDeskripsi">Deskripsi</label>
                        <textarea class="form-control" name="txtEditDeskripsi" id="txtEditDeskripsi" autocomplete="off"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="kategori">Kategori</label>
                        <select class="form-control editKategori" name="txtEditKategori" id="txtEditKategori" style="width: 100%;" autocomplete="off">
                            <option value=""></option>
                            <?php foreach ($kategori as $ctg) : ?>
                                <option value="<?= $ctg['id_kategori']; ?>"><?= $ctg['nama_kategori']; ?></option>
                            <?php endforeach; ?>
                    ...
                    <div class="form-group">
                        <label for="txtHarga">Harga</label>
                        <input type="text" class="form-control" name="txtEditHarga" id="txtEditHarga" placeholder="Harga" autocomplete="off">
                    </div>
                    <div class="form-group w-25">
                        <label for="txtStok">Stok</label>
                        <input type="number" class="form-control" name="txtEditStok" id="txtEditStok" placeholder="Stok" min="1" autocomplete="off">
                    </div>
                    <label for="gambar">Gambar</label>
                    <div class="input-group mb-3 w-50">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="editGambar" id="editGambar" aria-describedby="inputGroupFileAddon01" onchange="loadImg(event)">
                            <label class="custom-file-label" for="gambar">Choose file</label>
                        </div>
                    </div>
                    <img id="outputEdit" width="100px" style="margin-left: 300px; margin-top: -90px">
            </div>
            <div class="modal-footer" style="border-top: 0 none;">
                <button type="button" class="btn btn-light mr-2" data-dismiss="modal">Batal</button>
